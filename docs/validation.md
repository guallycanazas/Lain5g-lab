...
La ruta `4g-lte-sim` revisa EPC, evidencia S1, registro de srsUE, bearer, interfaz UE y ping de datos sin iniciar IMS. `4g-volte-sim` añade servicios IMS, DNS y evidencia SIP.
